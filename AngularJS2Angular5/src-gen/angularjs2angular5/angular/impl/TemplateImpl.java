 ...
 * </p>
 * <ul>
 *   <li>{@link angularjs2angular5.angular.impl.TemplateImpl#getSentenciashtml <em>Sentenciashtml</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.TemplateImpl#getName <em>Name</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.TemplateImpl#getController <em>Controller</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemplateImpl extends MinimalEObjectImpl.Container implements Template {
	...
	protected EClass eStaticClass() {
		return AngularPackage.Literals.TEMPLATE;
	}
	...
	public EList<SentenciaHTML> getSentenciashtml() {
		if (sentenciashtml == null) {
			sentenciashtml = new EObjectContainmentEList<SentenciaHTML>(SentenciaHTML.class, this,
					AngularPackage.TEMPLATE__SENTENCIASHTML);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AngularPackage.TEMPLATE__NAME, oldName, name));
	}
	...
	public Componente getController() {
		if (controller != null && controller.eIsProxy()) {
			...
			if (controller != oldController) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AngularPackage.TEMPLATE__CONTROLLER,
	...
	public void setController(Componente newController) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AngularPackage.TEMPLATE__CONTROLLER, oldController,
					controller));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AngularPackage.TEMPLATE__SENTENCIASHTML:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AngularPackage.TEMPLATE__NAME:
			return getName();
		case AngularPackage.TEMPLATE__CONTROLLER:
			if (resolve)
