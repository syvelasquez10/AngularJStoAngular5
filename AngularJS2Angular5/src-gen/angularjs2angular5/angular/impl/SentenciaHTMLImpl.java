 ...
 * </p>
 * <ul>
 *   <li>{@link angularjs2angular5.angular.impl.SentenciaHTMLImpl#getSentenciashtml <em>Sentenciashtml</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.SentenciaHTMLImpl#getName <em>Name</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.SentenciaHTMLImpl#getPropiedades <em>Propiedades</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.SentenciaHTMLImpl#getCurlybraces <em>Curlybraces</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.SentenciaHTMLImpl#getDirectivas <em>Directivas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SentenciaHTMLImpl extends MinimalEObjectImpl.Container implements SentenciaHTML {
	...
	protected EClass eStaticClass() {
		return AngularPackage.Literals.SENTENCIA_HTML;
	}
	...
	public EList<SentenciaHTML> getSentenciashtml() {
		if (sentenciashtml == null) {
			sentenciashtml = new EObjectResolvingEList<SentenciaHTML>(SentenciaHTML.class, this,
					AngularPackage.SENTENCIA_HTML__SENTENCIASHTML);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AngularPackage.SENTENCIA_HTML__NAME, oldName, name));
	}
	...
	public EList<Propiedad> getPropiedades() {
		if (propiedades == null) {
			propiedades = new EObjectContainmentEList<Propiedad>(Propiedad.class, this,
					AngularPackage.SENTENCIA_HTML__PROPIEDADES);
		}
		return propiedades;
	}
	...
	public EList<CurlyBraces> getCurlybraces() {
		if (curlybraces == null) {
			curlybraces = new EObjectContainmentEList<CurlyBraces>(CurlyBraces.class, this,
					AngularPackage.SENTENCIA_HTML__CURLYBRACES);
		}
		return curlybraces;
	}
	...
	public EList<Directiva> getDirectivas() {
		if (directivas == null) {
			directivas = new EObjectContainmentEList<Directiva>(Directiva.class, this,
					AngularPackage.SENTENCIA_HTML__DIRECTIVAS);
		}
		return directivas;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AngularPackage.SENTENCIA_HTML__PROPIEDADES:
			return ((InternalEList<?>) getPropiedades()).basicRemove(otherEnd, msgs);
		case AngularPackage.SENTENCIA_HTML__CURLYBRACES:
			return ((InternalEList<?>) getCurlybraces()).basicRemove(otherEnd, msgs);
		case AngularPackage.SENTENCIA_HTML__DIRECTIVAS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AngularPackage.SENTENCIA_HTML__SENTENCIASHTML:
			return getSentenciashtml();
		case AngularPackage.SENTENCIA_HTML__NAME:
			return getName();
		case AngularPackage.SENTENCIA_HTML__PROPIEDADES:
