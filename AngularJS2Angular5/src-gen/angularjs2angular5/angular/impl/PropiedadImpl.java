 ...
 * </p>
 * <ul>
 *   <li>{@link angularjs2angular5.angular.impl.PropiedadImpl#getName <em>Name</em>}</li>
 *   <li>{@link angularjs2angular5.angular.impl.PropiedadImpl#getValor <em>Valor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropiedadImpl extends MinimalEObjectImpl.Container implements Propiedad {
	...
	protected EClass eStaticClass() {
		return AngularPackage.Literals.PROPIEDAD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AngularPackage.PROPIEDAD__NAME, oldName, name));
	}
	...
	public void setValor(String newValor) {
		...
		valor = newValor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AngularPackage.PROPIEDAD__VALOR, oldValor, valor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AngularPackage.PROPIEDAD__NAME:
			return getName();
		case AngularPackage.PROPIEDAD__VALOR:
			return getValor();
		}
