...
public class AngularjsPackageImpl extends EPackageImpl implements AngularjsPackage {
	 ...
	 * @generated
	 */
	public EReference getSetenciaHTML_Markup() {
	...
	public EReference getSetenciaHTML_Setenciahtml() {
		return (EReference)setenciaHTMLEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getSetenciaHTML_Name() {
		return (EAttribute)setenciaHTMLEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getSetenciaHTML_Propiedades() {
		return (EReference)setenciaHTMLEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getSetenciaHTML_SelfClosing() {
		return (EAttribute)setenciaHTMLEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getController_Parametro() {
	 ...
	 * @generated
	 */
	public EReference getModule_Parametro() {
	 ...
	 * @generated
	 */
	public EReference getFuncion_Parametro() {
	...
	public void createPackageContents() {
		...
		createEReference(setenciaHTMLEClass, SETENCIA_HTML__MARKUP);
		...
		createEReference(controllerEClass, CONTROLLER__PARAMETRO);
		...
		createEReference(moduleEClass, MODULE__PARAMETRO);
		...
		createEReference(funcionEClass, FUNCION__PARAMETRO);
	...
	public void initializePackageContents() {
		...
		directivaEClass.getESuperTypes().add(this.getMarkUp());
		curlyBracesEClass.getESuperTypes().add(this.getMarkUp());
		...
		initEReference(getSetenciaHTML_Markup(), this.getMarkUp(), null, "markup", null, 0, -1, SetenciaHTML.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getController_Parametro(), this.getParametro(), null, "parametro", null, 1, 1, Controller.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getModule_Parametro(), this.getParametro(), null, "parametro", null, 1, 1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFuncion_Parametro(), this.getParametro(), null, "parametro", null, 0, 1, Funcion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
