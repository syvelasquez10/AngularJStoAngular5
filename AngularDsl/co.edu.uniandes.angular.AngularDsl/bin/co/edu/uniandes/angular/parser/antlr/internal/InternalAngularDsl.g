...
@after {
	...
	(
		...
		this_PUNTO_Y_COMA_6=RULE_PUNTO_Y_COMA
		{
...
// Entry rule entryRuleAnotacion
entryRuleAnotacion returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAnotacionRule()); }
	iv_ruleAnotacion=ruleAnotacion
	{ $current=$iv_ruleAnotacion.current; }
	EOF;

// Rule Anotacion
ruleAnotacion returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		this_LLAVE_IZQUIERDA_3=RULE_LLAVE_IZQUIERDA
		{
		...
		this_LLAVE_DERECHA_7=RULE_LLAVE_DERECHA
		{
