...
public class AngularDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_CurlyBraces_DollarSignKeyword_2_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_CurlyBraces_DollarSignKeyword_2_q = new TokenAlias(false, true, grammarAccess.getCurlyBracesAccess().getDollarSignKeyword_2());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_CurlyBraces_DollarSignKeyword_2_q.equals(syntax))
				emit_CurlyBraces_DollarSignKeyword_2_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) LLAVE_IZQUIERDA LLAVE_IZQUIERDA (ambiguity) expresion=Expresion
	 */
	protected void emit_CurlyBraces_DollarSignKeyword_2_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
