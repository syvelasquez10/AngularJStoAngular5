 ...
 * </p>
 * <ul>
 *   <li>{@link Angularjs.mvc.impl.VariableImpl#getValor <em>Valor</em>}</li>
 *   <li>{@link Angularjs.mvc.impl.VariableImpl#getAnotacion <em>Anotacion</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends ObjetoJavaScriptImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return MvcPackage.Literals.VARIABLE;
	}
	...
	public void setValor(String newValor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MvcPackage.VARIABLE__VALOR, oldValor, valor));
	}
	...
	public NotificationChain basicSetAnotacion(Anotacion newAnotacion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MvcPackage.VARIABLE__ANOTACION, oldAnotacion, newAnotacion);
	...
	public void setAnotacion(Anotacion newAnotacion) {
		if (newAnotacion != anotacion) {
			...
			if (anotacion != null)
				msgs = ((InternalEObject)anotacion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MvcPackage.VARIABLE__ANOTACION, null, msgs);
			if (newAnotacion != null)
				msgs = ((InternalEObject)newAnotacion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MvcPackage.VARIABLE__ANOTACION, null, msgs);
			msgs = basicSetAnotacion(newAnotacion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MvcPackage.VARIABLE__ANOTACION, newAnotacion, newAnotacion));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MvcPackage.VARIABLE__ANOTACION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MvcPackage.VARIABLE__VALOR:
				return getValor();
			case MvcPackage.VARIABLE__ANOTACION:
				return getAnotacion();
		}
