 ...
 * </p>
 * <ul>
 *   <li>{@link Angularjs.mvc.impl.AnotacionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnotacionImpl extends MinimalEObjectImpl.Container implements Anotacion {
	...
	protected EClass eStaticClass() {
		return MvcPackage.Literals.ANOTACION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MvcPackage.ANOTACION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MvcPackage.ANOTACION__VALUE:
				return getValue();
		}
