 ...
 * </p>
 * <ul>
 *   <li>{@link Angularjs.html.impl.ExpresionImpl#getValor <em>Valor</em>}</li>
 *   <li>{@link Angularjs.html.impl.ExpresionImpl#getReferencia <em>Referencia</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpresionImpl extends MinimalEObjectImpl.Container implements Expresion {
	...
	protected EClass eStaticClass() {
		return HtmlPackage.Literals.EXPRESION;
	}
	...
	public void setValor(String newValor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.EXPRESION__VALOR, oldValor, valor));
	}
	...
	public NotificationChain basicSetReferencia(Referencia newReferencia, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HtmlPackage.EXPRESION__REFERENCIA, oldReferencia, newReferencia);
	...
	public void setReferencia(Referencia newReferencia) {
		if (newReferencia != referencia) {
			...
			if (referencia != null)
				msgs = ((InternalEObject)referencia).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HtmlPackage.EXPRESION__REFERENCIA, null, msgs);
			if (newReferencia != null)
				msgs = ((InternalEObject)newReferencia).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HtmlPackage.EXPRESION__REFERENCIA, null, msgs);
			msgs = basicSetReferencia(newReferencia, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.EXPRESION__REFERENCIA, newReferencia, newReferencia));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HtmlPackage.EXPRESION__REFERENCIA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HtmlPackage.EXPRESION__VALOR:
				return getValor();
			case HtmlPackage.EXPRESION__REFERENCIA:
