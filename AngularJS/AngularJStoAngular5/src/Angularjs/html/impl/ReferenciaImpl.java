 ...
 * </p>
 * <ul>
 *   <li>{@link Angularjs.html.impl.ReferenciaImpl#getObjeto <em>Objeto</em>}</li>
 *   <li>{@link Angularjs.html.impl.ReferenciaImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenciaImpl extends MinimalEObjectImpl.Container implements Referencia {
	...
	protected EClass eStaticClass() {
		return HtmlPackage.Literals.REFERENCIA;
	}
		...
		if (objeto != null && objeto.eIsProxy()) {
			...
			if (objeto != oldObjeto) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HtmlPackage.REFERENCIA__OBJETO, oldObjeto, objeto));
			}
		}
		return objeto;
	}
	...
	public void setObjeto(ObjetoJavaScript newObjeto) {
		...
		objeto = newObjeto;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.REFERENCIA__OBJETO, oldObjeto, objeto));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.REFERENCIA__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HtmlPackage.REFERENCIA__OBJETO:
				if (resolve) return getObjeto();
				return basicGetObjeto();
			case HtmlPackage.REFERENCIA__NAME:
				return getName();
		}
