 ...
 * </p>
 * <ul>
 *   <li>{@link Angularjs.html.impl.PropiedadImpl#getName <em>Name</em>}</li>
 *   <li>{@link Angularjs.html.impl.PropiedadImpl#getValor <em>Valor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropiedadImpl extends MinimalEObjectImpl.Container implements Propiedad {
	...
	protected EClass eStaticClass() {
		return HtmlPackage.Literals.PROPIEDAD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.PROPIEDAD__NAME, oldName, name));
	}
	...
	public void setValor(String newValor) {
		...
		valor = newValor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.PROPIEDAD__VALOR, oldValor, valor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HtmlPackage.PROPIEDAD__NAME:
				return getName();
			case HtmlPackage.PROPIEDAD__VALOR:
				return getValor();
		}
