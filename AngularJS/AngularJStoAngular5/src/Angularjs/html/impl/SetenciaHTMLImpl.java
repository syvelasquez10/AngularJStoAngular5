 ...
 * </p>
 * <ul>
 *   <li>{@link Angularjs.html.impl.SetenciaHTMLImpl#getSetenciahtml <em>Setenciahtml</em>}</li>
 *   <li>{@link Angularjs.html.impl.SetenciaHTMLImpl#getName <em>Name</em>}</li>
 *   <li>{@link Angularjs.html.impl.SetenciaHTMLImpl#getPropiedades <em>Propiedades</em>}</li>
 *   <li>{@link Angularjs.html.impl.SetenciaHTMLImpl#isSelfClosing <em>Self Closing</em>}</li>
 *   <li>{@link Angularjs.html.impl.SetenciaHTMLImpl#getDirectivas <em>Directivas</em>}</li>
 *   <li>{@link Angularjs.html.impl.SetenciaHTMLImpl#getCurlybraces <em>Curlybraces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetenciaHTMLImpl extends MinimalEObjectImpl.Container implements SetenciaHTML {
	...
	protected EClass eStaticClass() {
		return HtmlPackage.Literals.SETENCIA_HTML;
	}
	...
	public EList<SetenciaHTML> getSetenciahtml() {
		if (setenciahtml == null) {
			setenciahtml = new EObjectResolvingEList<SetenciaHTML>(SetenciaHTML.class, this, HtmlPackage.SETENCIA_HTML__SETENCIAHTML);
		}
		return setenciahtml;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.SETENCIA_HTML__NAME, oldName, name));
	}
	...
	public EList<Propiedad> getPropiedades() {
		if (propiedades == null) {
			propiedades = new EObjectContainmentEList<Propiedad>(Propiedad.class, this, HtmlPackage.SETENCIA_HTML__PROPIEDADES);
		}
		return propiedades;
	}
	...
	public void setSelfClosing(boolean newSelfClosing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlPackage.SETENCIA_HTML__SELF_CLOSING, oldSelfClosing, selfClosing));
	}
	...
	public EList<Directiva> getDirectivas() {
		if (directivas == null) {
			directivas = new EObjectResolvingEList<Directiva>(Directiva.class, this, HtmlPackage.SETENCIA_HTML__DIRECTIVAS);
		}
		return directivas;
	}
	...
	public EList<CurlyBraces> getCurlybraces() {
		if (curlybraces == null) {
			curlybraces = new EObjectContainmentEList<CurlyBraces>(CurlyBraces.class, this, HtmlPackage.SETENCIA_HTML__CURLYBRACES);
		}
		return curlybraces;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HtmlPackage.SETENCIA_HTML__PROPIEDADES:
				return ((InternalEList<?>)getPropiedades()).basicRemove(otherEnd, msgs);
			case HtmlPackage.SETENCIA_HTML__CURLYBRACES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HtmlPackage.SETENCIA_HTML__SETENCIAHTML:
				return getSetenciahtml();
			case HtmlPackage.SETENCIA_HTML__NAME:
				return getName();
			case HtmlPackage.SETENCIA_HTML__PROPIEDADES:
				return getPropiedades();
			case HtmlPackage.SETENCIA_HTML__SELF_CLOSING:
				return isSelfClosing();
			case HtmlPackage.SETENCIA_HTML__DIRECTIVAS:
