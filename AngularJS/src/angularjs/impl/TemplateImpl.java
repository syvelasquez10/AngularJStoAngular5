 ...
 *   <li>{@link angularjs.impl.TemplateImpl#getDirectiva <em>Directiva</em>}</li>
...
public class TemplateImpl extends MinimalEObjectImpl.Container implements Template {
	...
	public EList<SetenciaHTML> getSetenciahtml() {
		if (setenciahtml == null) {
			setenciahtml = new EObjectContainmentEList<SetenciaHTML>(SetenciaHTML.class, this, AngularjsPackage.TEMPLATE__SETENCIAHTML);
		}
		return setenciahtml;
	}
	...
	public EList<Directiva> getDirectiva() {
		if (directiva == null) {
			directiva = new EObjectContainmentEList<Directiva>(Directiva.class, this, AngularjsPackage.TEMPLATE__DIRECTIVA);
		}
		return directiva;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AngularjsPackage.TEMPLATE__DIRECTIVA:
