...
public class AngularJSAppImpl extends MinimalEObjectImpl.Container implements AngularJSApp {
	...
	public EList<Template> getTemplates() {
		if (templates == null) {
			templates = new EObjectContainmentEList<Template>(Template.class, this, AngularjsPackage.ANGULAR_JS_APP__TEMPLATES);
		}
		return templates;
	}
	...
	public EList<Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<Module>(Module.class, this, AngularjsPackage.ANGULAR_JS_APP__MODULES);
		}
		return modules;
	}
	...
	public EList<Parametro> getParametros() {
		if (parametros == null) {
			parametros = new EObjectContainmentEList<Parametro>(Parametro.class, this, AngularjsPackage.ANGULAR_JS_APP__PARAMETROS);
		}
		return parametros;
	}
